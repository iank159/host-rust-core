...
//! the gateway pallet.
//!
//! Username resolution ([`crate::application::dotns::discover_pop_controller`], [`crate::application::dotns::resolve_labels`]) is
//! written once against the [`crate::application::dotns::DotnsTransport`] trait. The headless CLI's
...
/// [`crate::application::dotns::resolve_labels`] strips the network TLD.
///
...
/// for [`crate::application::dotns::DotnsTransport::view`] implementations.
...
/// [`crate::application::dotns::discover_pop_controller`], which tells them apart.
